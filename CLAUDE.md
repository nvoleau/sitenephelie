...
3. Vraies photos des gîtes — aucune fournie à ce stade ; des espaces réservés sobres (`components/GitePlaceholderImage.tsx`) remplacent `next/image` en attendant, plutôt que des photos de stock.
