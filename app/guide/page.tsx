...
// En attendant, on réutilise une photo réelle de la galerie commune, comme le
// fait déjà giteCardImage dans lib/data/site-images.ts pour les fiches gîtes
// sans photo dédiée — pas une photo inventée, un choix arbitraire temporaire.
const fallbackCardImage = galleryPhotos[3];
          ...
          <Link key={slug} href={`/guide/${slug}/`} className="group block">
            <div className="relative aspect-video w-full overflow-hidden rounded-md bg-paper-200">
              <Image
                ...
                alt={fallbackCardImage.alt}
                width={fallbackCardImage.width}
                height={fallbackCardImage.height}
